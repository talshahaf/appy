...
def create(widget):
    ...
    widget.post(update_counter)
    return [TextView(text='User was present', textColor=0xb3ffffff, textSize=30, alignment='center', hcenter=widget.hcenter, bottom=btn.itop + 5),
            TextView(text='times', textColor=0xb3ffffff, textSize=30, alignment='center', hcenter=widget.hcenter, top=btn.ibottom + 5),
            btn]
