import os
from appy.widgets import register_widget, RelativeLayout, TextView, Button, java_context, file_uri, Widget, request_permissions
...
def ping_click(widget):
    ...
    if widget.config.true_for_html_false_for_notification:
        ...
        make_notification(notification_intent_filter, widget.widget_id, 
                          ...
                          'Pong', java.clazz.android.R.drawable().ic_menu_search,
