...
def refresh_button(on_click, name=None, initial_refresh=None, widget=None, timeout=None, interval=None):
    btn = ImageButton(style='dark_btn_oval_nopad', colorFilter=0xffffffff, width=140, height=140, left=0, bottom=0, imageResource=java.clazz.com.appy.R.drawable().ic_action_refresh)
